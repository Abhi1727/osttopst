      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="space-y-4 md:space-y-6">
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
            {/* OST Card */}
            <div className="bg-white p-6 md:p-10 rounded-3xl shadow-sm border border-slate-200 flex flex-col h-full space-y-6 md:space-y-8 transition-all hover:shadow-md">
              <div className="text-center space-y-2">
            ...
            <div className="bg-white p-6 md:p-10 rounded-3xl shadow-sm border border-slate-200 flex flex-col h-full space-y-6 md:space-y-8 transition-all hover:shadow-md">
              ...
              <div className="space-y-4 sm:space-y-6 text-slate-700">
                <p className="leading-relaxed text-sm sm:text-base md:text-lg font-medium">
                  {isPdf ? (
                    <>
                      A PDF file is also known as{" "}
                      <strong>Portable Document Format</strong>. This file type
                      is utilized to present documents in a consistent layout
                      across all devices and platforms, instead of software or
                      any functioning system.
                    </>
                  ) : isJson ? (
                    <>
                      A JSON file is also known as{" "}
                      <strong>JavaScript Object Notation</strong>. This file
                      type is utilized to gather and exchange organized data
                      into a light, text-based structure, which is simple for
                      humans as well as machines to read and process.
                    </>
                  ) : isMbox ? (
                    <>
                      An MBOX file is also known as a{" "}
                      <strong>Mailbox Storage File</strong>. This file type
                      collects several email messages into a single text file,
                      with all messages saved consecutively. It is used by
                      various email clients for gathering large volumes of
                      emails effectively.
                    </>
                  ) : isEml ? (
                    <>
                      An EML file is also known as an{" "}
                      <strong>Email Message Format</strong>. This file type
                      gathers one email message with content, attachments,
                      headers and data in a usual format. It is mainly used for
                    ...
                    <>
                      ...
                      appointments, contacts, and to-dos that could be saved
                      onto one's computer independently from any email server
                      account (it can be created as needed).
                    </>
                  )}
                </p>
                <div className="space-y-3 sm:space-y-4 pt-2">
                  <p className="text-sm sm:text-base md:text-lg">
                    ...
                    {isPdf
                      ? "Protects the document format for sharing, archiving, and printing."
                      : isJson
                        ? "Gathers and exchanges organized data between the server and applications."
                        : isMbox
                  ...
                  <p className="text-sm sm:text-base md:text-lg">
                    ...
                    {isPdf
                      ? "Not rely on any server, an independent format."
                      : isJson
                        ? "Utilized with web servers and APIs for the transmission of data."
                        : isMbox
                  ...
                  <p className="text-sm sm:text-base md:text-lg">
                    <strong className="text-slate-900">Adaptability:</strong>{" "}
                    {isPdf
                      ? "It is portable and can be opened on any device"
                      : isJson
                        ? "It is adaptable and used on various programming languages and platforms."
                        : isMbox
                  ...
                  <p className="text-sm sm:text-base md:text-lg">
                    ...
                    {isPdf
                      ? "Use for safe and secure document sharing, invoices, and others."
                      : isJson
                        ? "Mainly for web applications, APIs, and data exchange between the systems."
                        : isMbox
