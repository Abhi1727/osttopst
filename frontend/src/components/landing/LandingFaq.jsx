...
const LandingFaq = () => {
  ...
  return (
    <div className="bg-slate-50 font-sans flex flex-col py-16">
      {/* Header Section */}
      <div className="bg-slate-50 pb-16 px-4 text-center relative overflow-hidden">
      ...
      {/* Main Content */}
      <div className="max-w-[1400px] mx-auto px-6 w-full flex-1 pb-16">
        {/* FAQ Grid */}
